...
- [x] 3. 인증 및 권한 시스템 구현
  ...
  - [x] 3.4 서브포럼 구조 기반 권한 시스템 개선
    - 라우트 패턴을 `/category/{categoryId}/post/{postId}` 형식으로 수정
  ...
  - [x] 3.6 사용자 인터페이스 및 네비게이션 개선
    - 메인 페이지에 사용자 정보 및 로그인 상태 표시
    - 역할별 네비게이션 메뉴 (프로필, 관리자, 로그아웃)
    - 권한 기반 UI 요소 표시/숨김 로직
    - 비로그인 사용자용 로그인/회원가입 링크
    - _요구사항: 1.1, 1.4, 2.1_
